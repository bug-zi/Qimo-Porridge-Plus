...
export const getActiveStrategyGenerationJob = impl.getActiveStrategyGenerationJob
...
export const mergeCourseFeedbackRules = impl.mergeCourseFeedbackRules
export const getCourseFeedbackItems = impl.getCourseFeedbackItems
export const getOpenCourseFeedback = impl.getOpenCourseFeedback
export const retryCourseFeedbackProposal = impl.retryCourseFeedbackProposal
export const abandonCourseFeedback = impl.abandonCourseFeedback
export const updateCourseFeedbackRule = impl.updateCourseFeedbackRule
